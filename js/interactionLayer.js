...
function preload() {
    ...
    game.load.image('picture1', 'images/image.png');
    game.load.image('picture2', 'images/pick4.png');
    game.load.image('picture3', 'images/sample1.png');
    game.load.image('picture4', 'images/specialfunctions.png');
    game.load.image('picture5', 'images/stop.png');
    game.load.image('picture6', 'images/sample1.png');
    game.load.image('picture7', 'images/pick4.png');
